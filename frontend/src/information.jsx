...
const instructorIgnacioBruvera = {
    ...
    yearsOfPractice: 10,
    bio: `
        <p>Nació en Gral. Villegas en 1984.</p>
        <p>Comenzó su práctica en el año 2005 en la escuela Lou Wan Gu de La Plata bajo la instrucción del maestro <a href="/instructores/prof-nahuel-campanari">Nahuel Campanari</a>.</p>
        <p>Posee la graduación de 3er Kap desde 2014 en el Instituto Li Hon Ki.</p>
        <p>Desde 2017 está cargo de la escuela <a href="/filiales/filial-la-plata">Lou Wan Gu como filial del Instituto LHK</a> y es discípulo del <a href="/instructores/sifu-fabian-gonzalez">Sifu Fabian González</a>.</p>
    `,
    photo: ignacioBruFace,
